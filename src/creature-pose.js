...
function feedingPose(resident, time) {
  ...
  return { eating, open: opening * envelope, chew: eating ? Math.sin(elapsed / period * Math.PI * 4) * envelope : 0,
    ...
    tongue: resident.species === 'lizard' && eating ? Math.max(0, Math.sin(Math.min(1, cycle / 0.38) * Math.PI)) * envelope : 0,
...
module.exports = { drawingSize, applyCreaturePose, eyeGaze, feedingPose };